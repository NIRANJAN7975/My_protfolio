...
import '../styles.css';
import myImage from '../pages/pic.jpg';
    ...
    <div className="home">
      ...
      <div className="content-container">
        <div className="text-section">
          <h1>
            {Array.from('Niranjan N').map((char, index) => (
              <span key={index}>
                {char === ' ' ? '\u00A0' : char}
              </span>
            ))}
          ...
          <p>
            {Array.from('I\'m a full-stack developer with expertise in machine learning, data science, and app development. I thrive on transforming innovative ideas into functional digital solutions, building seamless web applications, and leveraging data-driven insights to create impactful experiences.').map((char, index) => (
              <span key={index}>
                {char === ' ' ? '\u00A0' : char}
              </span>
            ))}
